...
export const ACCESS_AREAS: AccessArea[] = [
  ...
  { key: "mastercover", label: "MasterCover (insurance)", description: "Insurance quotes and bound policies.", group: "FinTech" },
  { key: "vato", label: "VATO", description: "Vessel valuation & titling checks (lender product).", group: "FinTech" },
